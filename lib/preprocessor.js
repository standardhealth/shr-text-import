...
class Preprocessor extends SHRDataElementParserVisitor {
  ...
  preprocessConfig(file) {
    ...
    if (file != null) {
      ...
      logger.warn(`No project configuration file found, currently using default EXAMPLE identifiers. Auto-generating a proper 'config.json' in your specifications folder with the following format: 
