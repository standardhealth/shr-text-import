...
class DataElementImporter extends SHRDataElementParserListener {
  ...
  pushCurrentDefinition() {
    /*if (this._specs.dataElements._nsMap.has(this._currentNs)) {
      if (this._specs.dataElements._nsMap.get(this._currentNs).has(this._currentDef.identifier._name)) {
        logger.error('Name "%s" already exists. ERROR_CODE:11033', this._currentDef.identifier._name);
      };
    }*/
