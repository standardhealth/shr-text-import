...
class DataElementImporter extends SHRDataElementParserListener {
  ...
  enterEntryDef(ctx) {
    ...
    this._currentDef = new DataElement(id, true, ctx.entryHeader().KW_ABSTRACT() != null).withGrammarVersion(this._currentGrammarVersion);
  }
